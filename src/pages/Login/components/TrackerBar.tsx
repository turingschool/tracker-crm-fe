		...
		<>
			...
			<div className='title-wrap w-6/12 flex flex-col justify-center items-center bg-[#046576]'>
				<div className='app-name-and-author flex justify-center'>
					<h1 className='tracker font-sans font-[Helvetica Neue] text-2xl md:text-7xl  font-semibold tracking-wide text-slate-100'>Tracker</h1>
					<h2 className='by-turing font-sans font-[Helvetica Neue] md:text-2xl font-bold leading-9 tracking-wide text-[#34a6bb]'><br />&nbsp; by Turing</h2>
				</div>
