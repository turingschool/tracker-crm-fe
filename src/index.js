...
import { getWebAutoInstrumentations } from '@opentelemtry/auto-instrumentations-web'

const configDefaults = {
  ignoreNetworkEvents: true,
  // propagateTraceHeaderCorsUrls: [
  // /.+/g
  //This looks like regex.  Specify the URL of the domain we want to include (I assume just the BE?)
  // ]
}
...
const sdk = new HoneycombWebSDK({
  ...
  apiKey: `${import.meta.env.HONEYCOMB_API_KEY}`, // Replace with your Honeycomb Ingest API Key.  NOTE: I hope this is the same as the main API key I extracted earlier...
