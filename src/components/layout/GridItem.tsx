...
const ApplicationsGrid: React.FC = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        const token = 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJyb2xlcyI6WyJ1c2VyIl0sImV4cCI6MTczNDQ3NTk2NH0.2ioaIqAyRhtXUwOWCdvhSB2vycYj0Rkr-wiFbl0XFgA';
  
        const response = await fetch('localhost:3001/api/v1/users/1/job_applications', {
          method: 'GET',
          headers: {
